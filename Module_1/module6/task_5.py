...
hour = 1
task_count = 0
shoptask = "В магазин заходить не нужно."
print("Начался 8-часовой рабочий день")
while hour <= 8:
  print(hour, "час")
  hour += 1
  task_count += int(input("Сколько задач решит Максим? "))
  wifecall = int(input("Звонит жена. Взять трубку? (1-да, 0-нет) "))
  if wifecall == 1:
    shoptask = "Нужно зайти в магазин."
