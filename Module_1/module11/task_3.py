...
weight = int(input("Укажите размер файла для скачивания: "))
speed = int(input("Какова скорость вашего соединения? "))
time = ceil(weight/speed)
for x in range(1, time):
  print(f"Прошло {x} сек. Скачано {speed*x} из {weight} Мб {round(speed*x/weight*100, 1)}%")
print(f"Прошло {time} сек. Скачано {weight} из {weight} Мб 100%")